...
DoLoop.prototype.sortBy = function ( sortBy ) {
  if (!arguments.length) return this._sortBy;
  this._sortBy = sortBy;
  return this;
};

DoLoop.prototype.readTheFiles = function ( readTheFiles ) {
  if (!arguments.length) return this._readTheFiles;
  this._readTheFiles = readTheFiles;
  return this;
};
    ...
    if ( fileStats.isFile() ) {
      ...
      promises[idx] = new Promise(
       function(resolve, reject) {
         ...
         // if reading files is turned off, resolve directly to callback without data
         if ( _this._readTheFiles !== true ) resolve(null);
